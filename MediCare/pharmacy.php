		...
		<div class="wrapper">
			<div class="sidebar">
				...
				<ul>
		 			...
		 			<li><a href="kajolshah.php">Al-MadinaPharmacy</a></li>
		 		</ul>
			</div>
			<div class="about">
			<div class="main_content">
				<div class="header"><h1>Rahman Pharmacy</h1><br> Contact:01842429020 </br> Email:rahman.pharmacy@gmail.com</br>
				<div class="info">	
					
					<div class="ex">
		 			 <img src="Medicine/ppe demo.jpg"/>
					 <p> PPE </br> Taka:2000 </p>
		 		</div>
		 		<div class="ex">
		 			 <img src="Medicine/histacin.jpg"/>
					 <p> Histacin </br> Taka:10</p>
		 		</div>
		 		<div class="ex">
		 			 <img src="Medicine/mask.jpg"/>
					 <p> Mask </br> Taka:15</p>
		 		</div> 
				<div class="ex">
		 			 <img src="Medicine/sergical.jpg"/>
					 <p> Sergical </br> Taka:1000</p>
		 		</div>
		 		<div class="ex">
		 			 <img src="Medicine/zofer.jpg"/>
					 <p> Zofer</br> Taka:15</p>
		 		</div> 
		 		</div>
				</div>
			</div> 
