		...
		<div class="background">
			...
			<div class="aboutusbody">
				...
				<div class="box_degin_1">
					<img src="img/logo1.jpg" alt="logo image"class="logoo">
					<h4>Vision:</h4>
					<h5 style="text-align: center;">The main purpose is to computerized the system and help people to collect most 
					of the information about MediCare services.The software makes easy for the people to 
					know any queries about medical or medical necessary things.</h5>
					
				</div>
				<div class="box_degin_1">
					
					<h3>Developer</h3>
					<h4>Web Engineering Project Done BY </h4>
					<h4>Sadia Akter Afrin & Jasmin Jahan Puspo</h4><br>
